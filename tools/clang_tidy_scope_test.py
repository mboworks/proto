...
class ClangTidyScopeTest(unittest.TestCase):
    def test_all_files_selects_every_first_party_translation_unit(self):
        database = [
            {"file": "mbo/proto/file.cc"},
            {"file": "mbo/proto/file_test.cc"},
            {"file": "external/dependency.cc"},
            {"file": "/absolute/generated.cc"},
        ]
        self.assertEqual(
            clang_tidy_scope.select_sources(database, ["--all-files"]),
            ["mbo/proto/file.cc", "mbo/proto/file_test.cc"],
        )
