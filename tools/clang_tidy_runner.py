...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--header-filter", default="(^|/)mbo/")
    parser.add_argument("--exclude-header-filter", default="(^|/)bazel-out/")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    extra_args.extend([f"--header-filter={args.header_filter}",
                       f"--exclude-header-filter={args.exclude_header_filter}"])
    return run_all(
        tasks,
        args.clang_tidy,
