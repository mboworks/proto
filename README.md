...
The [website](https://mboworks.github.io/proto/) forwards to the latest published
...
`https://mboworks.github.io/proto/`.
...
```sh
gh workflow run pages.yml --repo mboworks/proto --ref main \
...
Release coverage links select `https://mboworks.github.io/proto/coverage/tag/<version>/`,
